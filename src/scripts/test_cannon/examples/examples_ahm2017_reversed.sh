...
python3 cannon_test.py --train "4fs_ahm2017_perturbed_hrs[SNR=250]" \
...
python3 cannon_test.py --train "4fs_ahm2017_perturbed_lrs[SNR=250]" \
...
python3 cannon_test.py --train "4fs_ahm2017_perturbed_hrs[SNR=250,-1<[Fe/H]<1]" \
...
python3 cannon_test.py --train "4fs_ahm2017_perturbed_lrs[SNR=250,-1<[Fe/H]<1]" \
...
python3 cannon_test.py --train "4fs_ahm2017_perturbed_hrs[SNR=250,-5<[Fe/H]<-1]" \
...
python3 cannon_test.py --train "4fs_ahm2017_perturbed_lrs[SNR=250,-5<[Fe/H]<-1]" \
