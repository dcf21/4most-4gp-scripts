...
python2.7 cannon_test.py --train "galah_training_sample_4fs_hrs[SNR=250,-1<[Fe/H]<1]" \
...
python2.7 cannon_test.py --train "galah_training_sample_4fs_lrs[SNR=250,-1<[Fe/H]<1]" \
...
python2.7 cannon_test.py --train "galah_training_sample_4fs_hrs[SNR=250,-5<[Fe/H]<-1]" \
...
python2.7 cannon_test.py --train "galah_training_sample_4fs_lrs[SNR=250,-5<[Fe/H]<-1]" \
