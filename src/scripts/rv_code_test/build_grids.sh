...
../rearrange_libraries/rearrange.py --create --input-library turbospec_rv_templates --output-library rv_templates
../rearrange_libraries/rearrange.py --no-create --input-library hot_star_templates --output-library rv_templates

# Resample cross-correlation templates
./resample_cross_correlation_grid.py
