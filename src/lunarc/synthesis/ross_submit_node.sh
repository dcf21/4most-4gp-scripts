...
python synthesize_synthetic_dwarf_sample.py --every 80 --skip ${item} --create \
                           --workspace "${TMPDIR}/workspace" \
                           --output-library turbospec_synthetic_dwarf_sample_${item} \
                           --log-dir ../../../output_data/logs/synthetic_dwarf_sample_${item}
