...
#SBATCH -J 4fs_galah_test
#SBATCH -o stdout_4fs_galah_test_%j.out
#SBATCH -e stderr_4fs_galah_test_%j.out
cat $0
...
echo Starting rsync: `date`
rsync -a ${TMPDIR}/workspace/galah_test_sample_4fs_* ../../../workspace
echo Rsync done: `date`
