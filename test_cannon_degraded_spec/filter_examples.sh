...
python filter_cannon_output.py --input-file "../output_data/cannon/cannon_ahm2017_perturbed_hrs_10label" \
                               --criteria " -1<[Fe/H]<0.2" \
                               --output-file "../output_data/cannon/filtered_ahm2017_perturbed_hrs_10label"

python filter_cannon_output.py --input-file "../output_data/cannon/cannon_ahm2017_perturbed_lrs_10label" \
                               --criteria " -1<[Fe/H]<0.2" \
