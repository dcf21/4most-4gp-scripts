...
mkdir -p ../output_data/cannon/cannon
...
python cannon_test.py --train "hawkins_apokasc_training_set_lrs_snrperband[SNR=250]" \
                      ...
                      --description "4MOST LRS - 3 labels - SNR per band - Train on Hawkins(1). Test on Hawkins(2)." \
                      --labels "Teff,logg,[Fe/H]" \
                      --output-file "../output_data/cannon/cannon_hawkins_lrs_snrperband_3label"
python cannon_test.py --train "hawkins_apokasc_training_set_lrs_snrperband_noblue[SNR=250]" \
                      ...
                      --description "4MOST LRS - 3 labels - SNR per band + no blue - Train on Hawkins(1). Test on Hawkins(2)." \
                      --labels "Teff,logg,[Fe/H]" \
                      --output-file "../output_data/cannon/cannon_hawkins_lrs_snrperband_noblue_3label"
...
python cannon_test.py --train "hawkins_apokasc_training_set_hrs_snrperband[SNR=250]" \
                      ...
                      --description "4MOST HRS - 3 labels - SNR per band - Train on Hawkins(1). Test on Hawkins(2)." \
                      --labels "Teff,logg,[Fe/H]" \
                      --output-file "../output_data/cannon/cannon_hawkins_hrs_snrperband_3label"
python cannon_test.py --train "hawkins_apokasc_training_set_hrs_snrperband_noblue[SNR=250]" \
                      ...
                      --description "4MOST HRS - 3 labels - SNR per band + no blue - Train on Hawkins(1). Test on Hawkins(2)." \
                      --labels "Teff,logg,[Fe/H]" \
                      --output-file "../output_data/cannon/cannon_hawkins_hrs_snrperband_noblue_3label"
...
python cannon_test.py --train "hawkins_apokasc_training_set_lrs_snrperband[SNR=250]" \
                      --test "hawkins_apokasc_test_set_lrs_snrperband" \
                      --description "4MOST LRS - 10 labels - SNR per band - Train on Hawkins(1). Test on Hawkins(2)." \
                      --labels "Teff,logg,[Fe/H],[Ca/H],[Mg/H],[Ti/H],[Si/H],[Na/H],[Ni/H],[Cr/H]" \
                      --output-file "../output_data/cannon/cannon_hawkins_lrs_snrperband_10label"
python cannon_test.py --train "hawkins_apokasc_training_set_lrs_snrperband_noblue[SNR=250]" \
                      --test "hawkins_apokasc_test_set_lrs_snrperband_noblue" \
                      --description "4MOST LRS - 10 labels - SNR per band + no blue - Train on Hawkins(1). Test on Hawkins(2)." \
                      --labels "Teff,logg,[Fe/H],[Ca/H],[Mg/H],[Ti/H],[Si/H],[Na/H],[Ni/H],[Cr/H]" \
                      --output-file "../output_data/cannon/cannon_hawkins_lrs_snrperband_noblue_10label"
...
python cannon_test.py --train "hawkins_apokasc_training_set_hrs_snrperband[SNR=250]" \
                      ...
                      --labels "Teff,logg,[Fe/H],[Ca/H],[Mg/H],[Ti/H],[Si/H],[Na/H],[Ni/H],[Cr/H]" \
                      --output-file "../output_data/cannon/cannon_hawkins_hrs_snrperband_10label"
python cannon_test.py --train "hawkins_apokasc_training_set_hrs_snrperband_noblue[SNR=250]" \
                      --test "hawkins_apokasc_test_set_hrs_snrperband_noblue" \
                      --labels "Teff,logg,[Fe/H],[Ca/H],[Mg/H],[Ti/H],[Si/H],[Na/H],[Ni/H],[Cr/H]" \
                      --output-file "../output_data/cannon/cannon_hawkins_hrs_snrperband_noblue_10label"
