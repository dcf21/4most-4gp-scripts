...
python cannon_test.py --train "4fs_apokasc_training_set_lrs[SNR=250]" --test "4fs_apokasc_test_set_lrs" --output-file "../output_data/cannon_4fs_lrs"
python cannon_test.py --train "4fs_apokasc_training_set_lrs_snrperband[SNR=250]" --test "4fs_apokasc_test_set_lrs_snrperband" --output-file "../output_data/cannon_4fs_lrs_snrperband"
python cannon_test.py --train "4fs_apokasc_training_set_lrs_snrperband_noblue[SNR=250]" --test "4fs_apokasc_test_set_lrs_snrperband_noblue" --output-file "../output_data/cannon_4fs_lrs_snrperband_noblue"
...
python cannon_test.py --train "4fs_apokasc_training_set_hrs[SNR=250]" --test "4fs_apokasc_test_set_hrs" --output-file "../output_data/cannon_4fs_hrs"
python cannon_test.py --train "4fs_apokasc_training_set_hrs_snrperband[SNR=250]" --test "4fs_apokasc_test_set_hrs_snrperband" --output-file "../output_data/cannon_4fs_hrs_snrperband"
python cannon_test.py --train "4fs_apokasc_training_set_hrs_snrperband_noblue[SNR=250]" --test "4fs_apokasc_test_set_hrs_snrperband_noblue" --output-file "../output_data/cannon_4fs_hrs_snrperband_noblue"
