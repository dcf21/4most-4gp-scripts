...
python2.7 rearrange.py --input-library 4fs_ges_dwarf_sample_lrs[SNR=100] \
                       --contamination-library 4fs_demo_stars_lrs[Starname=Sun] \
                       --contamination-fraction 0.1 \
                       --output-library tmp_ges_dwarf_A_lrs \
                       --output-library tmp_ges_dwarf_B_lrs \
                       --output-fraction 0.25 --output-fraction 0.75

# Contaminate a library of spectra with 1% of the Sun's lightpython2.7 rearrange.py --input-library 4fs_ges_dwarf_sample_lrs[SNR=100] \
python2.7 rearrange.py --input-library 4fs_ges_dwarf_sample_lrs \
                       --contamination-library 4fs_demo_stars_lrs[Starname=Sun] \
                       --contamination-fraction 0.1 \
