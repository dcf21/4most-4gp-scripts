...
#SBATCH -o stdout_4fs_ahm2017_sample_%j.out
#SBATCH -e stderr_4fs_ahm2017_sample_%j.out
cat $0
...
rsync -a ../workspace/turbospec_ahm2017_sample ${TMPDIR}/workspace/
echo Rsync done: `date`
echo Running 4fs script: `date`

python2.7 degrade_library_with_4fs.py --input-library turbospec_ahm2017_sample \
